...
\item A potentially useful webpage (work in progress): ``Causal Inference in R'':  \href{https://www.r-causal.org/}{https://www.r-causal.org/}
\item Nick Huntington-Klein: ``The Effect'': \href{https://theeffectbook.net/}{https://theeffectbook.net/} 
(easier to read for non-mathematical audience, but has a more social sciences/econometrics focus)
