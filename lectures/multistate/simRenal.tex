...
%----------------------------------------------------------------------
\begin{frame}
  \includegraphics[width=0.45\textwidth]{simRenal-states-col} \hfill
% \end{frame}
% %----------------------------------------------------------------------
% \begin{frame}{Simulated probabilities}
\includegraphics[width=0.50\textwidth]{simRenal-sP1}
\end{frame}
...
Transitions:
     To
From  NRA  Rem ESRD ESRD(Rem) Records: Events: Risk time: Persons:
  NRA 928 1759 7313         0    10000    9072   72462.56    10000
  Rem   0 1119    0       640     1759     640   14882.74     1759
  Sum 928 2878 7313       640    11759    9712   87345.29    10000
\end{Soutput}
\end{Schunk}
\pause
...
when     NRA    Rem ESRD(Rem) ESRD
  ...
  0.1 0.9951 0.9981    0.9981    1
  0.2 0.9891 0.9952    0.9952    1
\end{Soutput}
\begin{Sinput}
> tail(sP1, 3)
\end{Sinput}
\begin{Soutput}
      State
when      NRA    Rem ESRD(Rem) ESRD
  14.8 0.0994 0.2134    0.2750    1
  14.9 0.0972 0.2108    0.2729    1
  15   0.0948 0.2075    0.2705    1
\end{Soutput}
\begin{Sinput}
...
when  ESRD(Rem)    Rem    NRA ESRD
  0           0 0.0000 1.0000    1
  0.1         0 0.0030 0.9981    1
  0.2         0 0.0061 0.9952    1
\end{Soutput}
\begin{Sinput}
> tail(sP2, 3)
\end{Sinput}
\begin{Soutput}
      State
when   ESRD(Rem)    Rem    NRA ESRD
  14.8    0.0616 0.1756 0.2750    1
  14.9    0.0621 0.1757 0.2729    1
  15      0.0630 0.1757 0.2705    1
\end{Soutput}
\begin{Sinput}
> par(mar = c(3, 3, 0.5, 2), mgp = c(3, 1, 0) / 1.6, las = 1)
...
\begin{frame}[fragile,allowframebreaks]{Using a simulated
    \texttt{Lexis} object --- sohourn time}
\begin{Schunk}
\begin{Sinput}
> summary(sim1)
\end{Sinput}
...
lex.Cst
 ...
 7.246256  1.488274  0.000000  0.000000  8.734529 
\end{Soutput}
\end{Schunk}
During the first 15 years after entry, the expected time in remission
is 1.5 years out of an expected lifetime of 8.7 years, for a 40 year old man
\end{frame}
