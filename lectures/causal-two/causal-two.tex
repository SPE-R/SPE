...
for the {\it outcome} to occur within a fixed risk period (assuming no censoring, nor competing events), 
and \\ $X$ be an {\it exposure} variable or risk factor. 
\pause
\medskip
\item
Let $\pi_x$ = {\it risk} of the outcome to occur during the period in the
