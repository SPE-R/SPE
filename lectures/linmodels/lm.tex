...
$\to$ 
 Simple {\bf linear regression model} $Y = \alpha + \beta x + \epsilon$ is fitted.
\begin{semiverbatim}
...
\verb|> coef(m)| -- Prints the estimated regression coefficients
{\small
\begin{semiverbatim}
(Intercept)     gestwks 
    -4489.1       197.0 
...
at some meaningful reference value, for instance 40 weeks: % using e.g.
...
the reference value 40 of {\tt gestwks} in the normotensive group.
