...
par(mfcol=c(1,1))
plot(survfit(orca$suob~orca$sex), ylab="Proporton",xlab="Time (years)",lwd=c(2,1.5,1.5,2,1.5,1.5),lty=c(1,3,3,1,3,3),conf.int = T,col=c("red","blue"),main="Estimated survival (95% CI) and CDF")
