...
install.packages(c('bookdown', 'cowplot', 'cranly', 'dagitty', 'dplyr', 'Epi', 'foreign', 'ggplot2', 'grid', 'knitr', 'mgcv', 'popEpi', 'PSweight', 'purrr', 'renv', 'rmarkdown', 'sem', 'stdReg2', 'survival', 'tidyverse', 'tools'))
