\SweaveOpts{results=hide,keep.source=TRUE,eps=FALSE,include=FALSE,prefix.string=./graph/graph}
...
\centerline{\includegraphics[width=\textwidth]{./data-solutions/bentK}}
