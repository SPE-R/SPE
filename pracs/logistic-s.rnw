\SweaveOpts{results=verbatim, prefix.string=./graph/logistic}
...
<<Effects of hair eyes and freckles, echo=T>>=
...
<<Effect of hair2 using glm, echo=T>>=
...
<<Joint frequency of nvsma4 and nvlar3,echo=T>>=
...
<<Effects of naevi on melanoma, echo=T>>=
...
{\tt age.cat, sex, nvsma4} and {\tt nvlar3}. What is the interpretation of the coefficients for {\tt nvsma4} and {\tt nvlar3}?
<<echo=T>>=
