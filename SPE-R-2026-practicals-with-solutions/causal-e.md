...
## (Intercept) 62.464351 0.3491921 178.88248 0.000000e+00 61.779947 63.148755
## beer         5.275899 0.5165428  10.21387 1.718761e-24  4.263494  6.288305
```
...
```
##              Estimate    StdErr           z            P       2.5%     97.5%
## (Intercept) 59.767739 0.3267875 182.8948248 0.000000e+00 59.1272473 60.408231
## beer         0.352019 0.5052169   0.6967681 4.859479e-01 -0.6381879  1.342226
## sex          9.893650 0.5033451  19.6557977 5.157190e-86  8.9071120 10.880189
```
...
```
##               Estimate     StdErr         z            P       2.5%      97.5%
## (Intercept) 31.7683562 2.86324335 11.095234 1.323126e-28 26.1565023 37.3802100
## beer        -1.7066599 0.52599058 -3.244659 1.175915e-03 -2.7375825 -0.6757373
## sex          9.2000067 0.48592429 18.933005 6.098293e-80  8.2476126 10.1524009
## bp           0.1992629 0.02025537  9.837536 7.758794e-23  0.1595631  0.2389627
```
...
```
##              Estimate    StdErr         z            P      2.5%     97.5%
## (Intercept) 62.953771 0.3602035 174.77279 0.000000e+00 62.247785 63.659757
## beer         7.277066 0.5328314  13.65735 1.825041e-42  6.232735  8.321396
```
...
```
##              Estimate    StdErr          z            P       2.5%     97.5%
## (Intercept) 60.035361 0.3304465 181.679543 0.000000e+00 59.3876976 60.683024
## beer         1.948192 0.5108737   3.813451 1.370400e-04  0.9468976  2.949486
## sex         10.707412 0.5089810  21.036958 3.010839e-98  9.7098275 11.704996
```
...
```
##               Estimate     StdErr          z            P       2.5%      97.5%
## (Intercept) 29.4985863 2.89204797 10.1998952 1.984865e-24 23.8302764 35.1668961
## beer        -0.4183574 0.53321410 -0.7845955 4.326908e-01 -1.4634378  0.6267231
## sex          9.5780299 0.49421029 19.3804746 1.128018e-83  8.6093955 10.5466642
## bp           0.2174755 0.02047521 10.6214014 2.369765e-26  0.1773448  0.2576061
```
...
```
##              Estimate    StdErr         z            P      2.5%     97.5%
## (Intercept) 141.83025 0.4502107 315.03085 0.000000e+00 140.94785 142.71265
## beer         13.46644 0.6659746  20.22065 6.442269e-91  12.16116  14.77173
```
...
## (Intercept) 112.3280412 2.68399570 41.8510511 0.000000e+00 107.0675063
## beer          9.9704768 0.71567923 13.9314883 4.077688e-44   8.5677713
## weight        0.4678371 0.04404664 10.6214014 2.369765e-26   0.3815072
## sex           0.1838231 0.85060571  0.2161085 8.289032e-01  -1.4833334
##                   97.5%
## (Intercept) 117.5885762
## beer         11.3731823
## weight        0.5541669
## sex           1.8509797
```
