...
## (Intercept) 62.60483 0.3502297 178.75362 0.000000e+00 61.918389 63.291264
## beer         5.70721 0.5250165  10.87053 1.592665e-27  4.678196  6.736223
```

```
##               Estimate    StdErr           z            P       2.5%     97.5%
## (Intercept) 59.7871731 0.3243171 184.3478871 0.000000e+00 59.1515232 60.422823
## beer         0.2465589 0.5145972   0.4791299 6.318462e-01 -0.7620331  1.255151
## sex         10.4952856 0.5114744  20.5196689 1.436877e-93  9.4928142 11.497757
```

```
##               Estimate     StdErr         z            P       2.5%      97.5%
## (Intercept) 26.8200844 2.65853130 10.088309 6.223249e-24 21.6094588 32.0307100
## beer        -2.1174034 0.51487652 -4.112449 3.914840e-05 -3.1265429 -1.1082640
## sex          9.2540607 0.48614887 19.035446 8.675056e-81  8.3012264 10.2068949
## bp           0.2359624 0.01890552 12.481141 9.462140e-36  0.1989083  0.2730165
```
...
```
##             Estimate    StdErr         z            P      2.5%     97.5%
## (Intercept) 62.65142 0.3557473 176.11213 0.000000e+00 61.954167 63.348671
## beer         7.09264 0.5332878  13.29984 2.319768e-40  6.047415  8.137865
```

```
##              Estimate    StdErr          z            P       2.5%     97.5%
## (Intercept) 60.053004 0.3414326 175.885408 0.000000e+00 59.3838090 60.722200
## beer         2.056876 0.5417545   3.796695 1.466382e-04  0.9950571  3.118696
## sex          9.678660 0.5384669  17.974475 3.087704e-72  8.6232839 10.734035
```

```
##               Estimate    StdErr          z            P       2.5%      97.5%
## (Intercept) 28.2551584 2.9118968  9.7033516 2.917539e-22 22.5479456 33.9623712
## beer        -0.4256703 0.5595356 -0.7607563 4.468026e-01 -1.5223400  0.6709994
## sex          8.5366384 0.5192913 16.4390172 1.005361e-60  7.5188461  9.5544306
## bp           0.2272196 0.0206796 10.9876193 4.383356e-28  0.1866883  0.2677508
```
...
```
##             Estimate    StdErr         z           P      2.5%     97.5%
## (Intercept) 141.2926 0.4566160 309.43416 0.00000e+00 140.39765 142.18756
## beer         13.5408 0.6844964  19.78214 4.24306e-87  12.19921  14.88239
```

```
##                Estimate     StdErr          z            P        2.5%
## (Intercept) 111.3707182 2.64200218 42.1539085 0.000000e+00 106.1924891
## beer          9.9471225 0.74606686 13.3327494 1.492925e-40   8.4848583
## weight        0.4757888 0.04330226 10.9876193 4.383356e-28   0.3909179
## sex           0.4210717 0.84716886  0.4970339 6.191651e-01  -1.2393488
##                   97.5%
## (Intercept) 116.5489473
## beer         11.4093866
## weight        0.5606596
## sex           2.0814921
```
