...
###################################################
### code chunk number 11: DMDK-s.rnw:312-314
###################################################
...
###################################################
### code chunk number 12: DMDK-s.rnw:318-326
###################################################
data(M.dk)
str(M.dk)
...
###################################################
### code chunk number 13: DMDK-s.rnw:331-334
###################################################
...
###################################################
### code chunk number 14: DMDK-s.rnw:343-346
###################################################
...
###################################################
### code chunk number 15: DMDK-s.rnw:359-377
###################################################
...
###################################################
### code chunk number 16: DMDK-s.rnw:399-403
###################################################
...
###################################################
### code chunk number 17: DMDK-s.rnw:427-431
###################################################
...
###################################################
### code chunk number 18: DMDK-s.rnw:435-439
###################################################
(CM <- rbind(M = c(1,0),
             W = c(0,1),
         'M/F' = c(1,-1)))
...
###################################################
### code chunk number 19: DMDK-s.rnw:477-481
###################################################
...
###################################################
### code chunk number 20: DMDK-s.rnw:491-493
###################################################
...
###################################################
### code chunk number 21: DMDK-s.rnw:538-542
###################################################
...
###################################################
### code chunk number 24: DMDK-s.rnw:612-622
###################################################
...
###################################################
### code chunk number 25: plgam-default
###################################################
par(mfcol = c(3,2))
...
###################################################
### code chunk number 26: DMDK-s.rnw:660-662
###################################################
...
###################################################
### code chunk number 27: DMDK-s.rnw:714-719
###################################################
pts <- seq(0, 12, 1/4)
