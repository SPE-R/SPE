## ----include=FALSE------------------------------------------------------------
knitr::opts_chunk$set(messages=FALSE, keep.source = TRUE, include = TRUE, eps = FALSE, prefix.string = "./graph/cont-eff")
...
## ----model mPen2 with increased flexibility-----------------------------------
