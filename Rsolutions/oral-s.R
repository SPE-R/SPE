...
## ----strsplit, echo=T,eval=TRUE-----------------------------------------------
str(orca2.spl)
head(orca2.spl)


## ----poisson, echo=T,eval=TRUE------------------------------------------------
m2pois1 <- glm(
...
## ----poissonresults, echo=T, fig=T,eval=TRUE----------------------------------
...
## ----poissonspline, echo=T, fig=T,eval=TRUE-----------------------------------
library(splines)
m2pspli <- 
  update(
    m2pois1, 
