...
## ----survcdf1, fig=TRUE, height=6, width=7------------------------------------
...
## ----cdfstage, fig=TRUE, height=6, width=7------------------------------------
...
## ----chstage, fig=TRUE, height=6, width=14------------------------------------
par(mfrow = c(1, 2))
...
## ----cdfsexage, fig=TRUE, height=6, width=12----------------------------------
...
## ----plotcif2, fig=TRUE, height=6, width=10-----------------------------------
col5 <- col5
