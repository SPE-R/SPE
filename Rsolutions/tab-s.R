## ----include=FALSE------------------------------------------------------------
# results / fig.show defaults are handled globally in _common.R via the
# SPE_SOLUTIONS flag (hidden in the exercise book, shown in the solutions book).
knitr::opts_chunk$set(prefix.string = "./graph/tab")
...
## ----exercise on tables, solution = TRUE--------------------------------------
...
## ----two way tables exc, solution = TRUE--------------------------------------
