```{r, include=FALSE}
knitr::opts_chunk$set(keep.source=TRUE,eps=FALSE,include=TRUE,eval=TRUE, results = 'hide', fig.show = 'hide' ,prefix.string='./graph/DMDK')
```
...
```{r }
Mtp <- mgcv::gam((lex.Xst == "Dead") ~ s(  A, bs = "cr", k = 10) +
                                 s(  P, bs = "cr", k = 10) +
                                 s(dur, bs = "cr", k = 10),
            offset = log(lex.dur),
            family = poisson,
