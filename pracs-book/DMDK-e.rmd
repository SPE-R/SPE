...
1.  Now estimate age-specific mortality curves for men and
    ...
    ```{r, eval = FALSE}
    r.m <- gamLexis(subset(SL, sex == "M"), ~ s(A, k = 15))
...
8.  The model we fitted has three time-scales: current age, current
    ...
    The reporting would therefore more naturally be showing predicted rates on the
    ...
    ```
9.  From the figure it seems that the duration effect is
