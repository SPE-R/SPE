...
```{r survcdf1, echo=TRUE, fig=TRUE, height=6, width=7,eval=TRUE}
...
```{r cdfstage, echo=T, fig=T, height=6, width=7,eval=TRUE}
...
```{r chstage, echo=T, fig=T, height=6, width=14,eval=TRUE}
par(mfrow = c(1, 2))
...
```{r cdfsexage, echo=TRUE, fig=TRUE, height=6, width=12,eval=TRUE}
...
```{r plotcif1, echo=T,fig=T,eval=TRUE}
par(mfrow = c(1, 2))
...
```{r plotcif2, echo=T, fig=T, height=6, width=10,eval=TRUE}
col5 <- col5
...
```{r stackedcif1, echo=TRUE, fig=TRUE, eval=TRUE}
...
```{r lexis 1, echo=T,show.BE=TRUE,eval=TRUE}
orca.lex <- Lexis(
