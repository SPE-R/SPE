...
```{r survcdf1, fig=TRUE, height=6, width=7}
...
```{r cdfstage, fig=TRUE, height=6, width=7}
...
```{r chstage, fig=TRUE, height=6, width=14}
par(mfrow = c(1, 2))
...
```{r cdfsexage, fig=TRUE, height=6, width=12}
...
```{r plotcif2, fig=TRUE, height=6, width=10}
col5 <- col5
