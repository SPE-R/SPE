...
options(digits=3)
=======
>>>>>>> eecd1103fbee27b94f1c5c511c417c331b79dd57
```
...
```{r Survobject, echo=T,eval=FALSE}
...
<<<<<<< HEAD
```{r survcdf1, echo=TRUE, fig=TRUE, height=6, width=7,eval=FALSE}
plot(s.all,main="KM estimate of the survival
     and cum. mortality proportions",
     xlab="years", ylab="Survival")
=======
```{r survcdf1, echo=T, fig=T, height=6, width=7,eval=FALSE}
plot(s.all)
>>>>>>> eecd1103fbee27b94f1c5c511c417c331b79dd57
...
```{r cdfstage, echo=T, fig=T, height=6, width=7,eval=FALSE}
...
```{r chstage, echo=T, fig=T, height=6, width=12,eval=FALSE}
par(mfrow = c(1, 2))
...
<<<<<<< HEAD
```{r cdfsexage, echo=TRUE, fig=TRUE, height=6, width=7,eval=FALSE}
...
=======
```{r cdfsexage, echo=T, fig=T, height=6, width=7,eval=FALSE}
s.agrx <- survfit(suob ~ agegr + sex, data = orca)
par(mfrow = c(1, 1))
plot(s.agrx,
...
```{r plotcif1, echo=T,fig=T,eval=FALSE}
par(mfrow = c(1, 2))
...
```{r plotcif2, echo=T, fig=T, height=6, width=10,eval=FALSE}
col5 <- c("green", "blue", "black", "red", "gray")
...
<<<<<<< HEAD
```{r stackedcif1, echo=TRUE, fig=TRUE, eval=FALSE}
...
=======
```{r stackedcif1, echo=T, fig=T, eval=FALSE}
par(mfrow = c(1, 1))
...
for the timebands
```{r poissonresults, echo=T, fig=T,eval=FALSE}
...
```{r poissonspline, echo=T, fig=T,eval=FALSE}
library(splines)
m2pspli <- 
  update(
    m2pois1, 
