...
orca <-  read.table(file = './data/oralca2.txt', header = TRUE, sep = " ", row.names = 1)
head(orca)
...
```{r chstage, echo=T, fig=T, height=6, width=12,eval=TRUE}
par(mfrow = c(1, 2))
...
```{r cdfsexage, echo=TRUE, fig=TRUE, height=6, width=7,eval=TRUE}
