...
\date{1-5 June 2026 (built 05 June 2026 14:30 UTC)}
...
## i Use `summarise(.groups = "drop_last")` to silence this message.
## i Use `summarise(.by = c(lowbw, gest4))` for per-operation
...
## i Use `summarise(.groups = "drop_last")` to silence this message.
## i Use `summarise(.by = c(gest4, lowbw))` for per-operation
##   grouping (`?dplyr::dplyr_by`) instead.
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{SPE-R-2026-practicals_files/SPE-R-2026-practicals_files/figure-latex/dagitty3-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{SPE-R-2026-practicals_files/SPE-R-2026-practicals_files/figure-latex/threedags-1.pdf}}
...
\NormalTok{\#\# {-}3.989 {-}0.744  0.010  0.766  3.593 }
\NormalTok{\#\# }
\NormalTok{\#\# Coefficients:}
\NormalTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)    }
\NormalTok{\#\# (Intercept)  0.03317    0.02455    1.35     0.18    }
\NormalTok{\#\# X           {-}0.00169    0.01488   {-}0.11     0.91    }
\NormalTok{\#\# W           {-}2.59961    0.03199  {-}81.27   \textless{}2e{-}16 ***}
\NormalTok{\#\# Z            1.01417    0.02120   47.85   \textless{}2e{-}16 ***}
\NormalTok{\#\# {-}{-}{-}}
...
\NormalTok{\#\# }
\NormalTok{\#\# Residual standard error: 1.1 on 1996 degrees of freedom}
\NormalTok{\#\# Multiple R{-}squared:  0.969,  Adjusted R{-}squared:  0.969 }
\NormalTok{\#\# F{-}statistic: 2.05e+04 on 3 and 1996 DF,  p{-}value: \textless{}2e{-}16}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\#\# Coefficients:}
\NormalTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)    }
\NormalTok{\#\# (Intercept)   0.1007     0.0509    1.98    0.048 *  }
\NormalTok{\#\# X             1.1314     0.0108  105.04   \textless{}2e{-}16 ***}
\NormalTok{\#\# Z             2.3803     0.0268   88.83   \textless{}2e{-}16 ***}
\NormalTok{\#\# {-}{-}{-}}
\NormalTok{\#\# Signif. codes:  0 \textquotesingle{}***\textquotesingle{} 0.001 \textquotesingle{}**\textquotesingle{} 0.01 \textquotesingle{}*\textquotesingle{} 0.05 \textquotesingle{}.\textquotesingle{} 0.1 \textquotesingle{} \textquotesingle{} 1}
\NormalTok{\#\# }
\NormalTok{\#\# Residual standard error: 2.28 on 1997 degrees of freedom}
\NormalTok{\#\# Multiple R{-}squared:  0.865,  Adjusted R{-}squared:  0.865 }
\NormalTok{\#\# F{-}statistic: 6.39e+03 on 2 and 1997 DF,  p{-}value: \textless{}2e{-}16}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\#\# Residuals:}
\NormalTok{\#\#    Min     1Q Median     3Q    Max }
\NormalTok{\#\# {-}3.721 {-}0.642  0.003  0.660  3.199 }
\NormalTok{\#\# }
\NormalTok{\#\# Coefficients:}
\NormalTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)    }
\NormalTok{\#\# (Intercept)  0.01958    0.02217    0.88     0.38    }
\NormalTok{\#\# X           {-}0.00604    0.01343   {-}0.45     0.65    }
\NormalTok{\#\# Q            1.07188    0.05024   21.33   \textless{}2e{-}16 ***}
\NormalTok{\#\# W           {-}3.03339    0.03531  {-}85.90   \textless{}2e{-}16 ***}
\NormalTok{\#\# Z            1.00354    0.01914   52.44   \textless{}2e{-}16 ***}
\NormalTok{\#\# {-}{-}{-}}
\NormalTok{\#\# Signif. codes:  0 \textquotesingle{}***\textquotesingle{} 0.001 \textquotesingle{}**\textquotesingle{} 0.01 \textquotesingle{}*\textquotesingle{} 0.05 \textquotesingle{}.\textquotesingle{} 0.1 \textquotesingle{} \textquotesingle{} 1}
\NormalTok{\#\# }
\NormalTok{\#\# Residual standard error: 0.99 on 1995 degrees of freedom}
\NormalTok{\#\# Multiple R{-}squared:  0.974,  Adjusted R{-}squared:  0.974 }
\NormalTok{\#\# F{-}statistic: 1.9e+04 on 4 and 1995 DF,  p{-}value: \textless{}2e{-}16}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{SPE-R-2026-practicals_files/graph/bentK.png}}
...
\begin{verbatim}
## Warning in Surv(time, event, type = "mstate"): type= 'mstate' is
## deprecated, use a factor variable as status
\end{verbatim}
...
\begin{verbatim}
## Warning in ay * as.numeric(nx) + ax: longer object length is not
...
\NormalTok{  Alive  7497 2499     9996    2499      54273     9996}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{sex     D     Y}
\NormalTok{  M  1343 27614}
\NormalTok{  F  1156 26659}
\end{Highlighting}
\end{Shaded}
\item
...
\NormalTok{Formula:}
\NormalTok{cbind(lex.Xst == "Dead", lex.dur) \textasciitilde{} s(A, k = 10)}

\NormalTok{Parametric coefficients:}
\NormalTok{            Estimate Std. Error z value Pr(\textgreater{}|z|)}
\NormalTok{(Intercept)    {-}3.53       0.05   {-}70.6   \textless{}2e{-}16}

\NormalTok{Approximate significance of smooth terms:}
\NormalTok{      edf Ref.df Chi.sq p{-}value}
\NormalTok{s(A) 4.34   5.33   1017  \textless{}2e{-}16}

\NormalTok{R{-}sq.(adj) =  0.00313   Deviance explained = 9.13\%}
\NormalTok{UBRE = {-}0.80407  Scale est. = 1         n = 60347}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ num [1:141, 1:3] 0.00132 0.00137 0.00142 0.00146 0.00152 ...}
...
\NormalTok{Parametric coefficients:}
\NormalTok{            Estimate Std. Error z value Pr(\textgreater{}|z|)}
\NormalTok{(Intercept)  {-}3.5407     0.0494   {-}71.7   \textless{}2e{-}16}

\NormalTok{Approximate significance of smooth terms:}
\NormalTok{        edf Ref.df Chi.sq p{-}value}
\NormalTok{s(A)   3.65   4.52 1013.2 \textless{} 2e{-}16}
\NormalTok{s(P)   1.02   1.05   17.6 3.5e{-}05}
\NormalTok{s(dur) 7.59   8.38   74.5 \textless{} 2e{-}16}
...
\NormalTok{2     60341      11813 {-}8.62    {-}95.9   \textless{}2e{-}16}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    k = 10)}
\NormalTok{  Resid. Df Resid. Dev    Df Deviance Pr(\textgreater{}Chi)}
\NormalTok{1     58112      10204                        }
\NormalTok{2     58122      10268 {-}9.46    {-}63.4  4.8e{-}10}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{         exp(Est.)  2.5\%    97.5\%}
\NormalTok{sexF      5.21e+04 0.000 2.38e+23}
\NormalTok{sexM:A    9.81e{-}01 0.977 9.86e{-}01}
\NormalTok{sexF:A    9.80e{-}01 0.975 9.86e{-}01}
\NormalTok{sexM:P    9.87e{-}01 0.972 1.00e+00}
\NormalTok{sexF:P    9.81e{-}01 0.965 9.98e{-}01}
\NormalTok{s(dur).1  6.63e{-}01 0.601 7.32e{-}01}
\NormalTok{s(dur).2  8.61e{-}01 0.795 9.31e{-}01}
\NormalTok{s(dur).3  8.85e{-}01 0.805 9.74e{-}01}
\NormalTok{s(dur).4  1.41e+00 0.945 2.11e+00}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{SPE-R-2026-practicals_files/SPE-R-2026-practicals_files/figure-latex/dagitty-1.pdf}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{  id sex  dob  doe  dor  dox event}
\NormalTok{1 17   M 1968 1996   NA 1997     2}
\NormalTok{2 26   F 1959 1990 1990 1996     1}
\NormalTok{3 27   F 1962 1988   NA 1993     3}
\NormalTok{4 33   M 1951 1995 1996 2004     0}
\NormalTok{5 42   F 1961 1988 1997 2004     0}
\NormalTok{6 46   F 1952 1983   NA 1991     2}
\end{Highlighting}
\end{Shaded}
\item
...
\NormalTok{                          coef exp(coef) se(coef)     z Pr(\textgreater{}|z|)}
\NormalTok{sexF                   {-}0.0553    0.9462   0.2750 {-}0.20  0.84052}
\NormalTok{I((doe {-} dob {-} 50)/10)  0.5219    1.6852   0.1366  3.82  0.00013}
\NormalTok{lex.Cst == "Rem"TRUE   {-}1.2624    0.2830   0.3848 {-}3.28  0.00104}

\NormalTok{                       exp(coef) exp({-}coef) lower .95 upper .95}
\NormalTok{sexF                       0.946      1.057     0.552     1.622}
\NormalTok{I((doe {-} dob {-} 50)/10)     1.685      0.593     1.290     2.202}
\NormalTok{lex.Cst == "Rem"TRUE       0.283      3.534     0.133     0.602}

\NormalTok{Concordance= 0.664  (se = 0.033 )}
\NormalTok{Likelihood ratio test= 30.3  on 3 df,   p=1e{-}06}
\NormalTok{Wald test            = 27.1  on 3 df,   p=6e{-}06}
\NormalTok{Score (logrank) test = 29.4  on 3 df,   p=2e{-}06}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{     To}
\NormalTok{From   NRA  Rem ESRD ESRD(Rem) Records: Events: Risk time: Persons:}
\NormalTok{  NRA 9854   29   69         0     9952      98        825      122}
\NormalTok{  Rem    0 3139    0         8     3147       8        260       32}
\NormalTok{  Sum 9854 3168   69         8    13099     106       1085      125}
\end{Highlighting}
\end{Shaded}
\item
...
\begin{Highlighting}[]
\NormalTok{                                 exp(Est.)    2.5\%   97.5\%}
\NormalTok{(Intercept)                         0.0166 0.00396   0.070}
\NormalTok{Ns(tfi, knots = c(0, 2, 5, 10))1    5.1892 1.94920  13.815}
\NormalTok{Ns(tfi, knots = c(0, 2, 5, 10))2   34.2000 1.76482 662.755}
\NormalTok{Ns(tfi, knots = c(0, 2, 5, 10))3    4.4332 2.17998   9.015}
\NormalTok{sexF                                0.9175 0.53626   1.570}
\NormalTok{I((doe {-} dob {-} 40)/10)              1.7008 1.30081   2.224}
\NormalTok{I(lex.Cst == "Rem")TRUE             0.2793 0.13140   0.594}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Parametric coefficients:}
\NormalTok{            Estimate Std. Error z value Pr(\textgreater{}|z|)}
\NormalTok{(Intercept)   {-}3.703      0.258  {-}14.34   \textless{}2e{-}16}
\NormalTok{sexF           0.958      0.373    2.57     0.01}

\NormalTok{Approximate significance of smooth terms:}
\NormalTok{        edf Ref.df Chi.sq p{-}value}
\NormalTok{s(tfi) 1.01   1.03   0.07    0.81}
...
\NormalTok{      1 2000 50.0 0.0    2.76     NRA      ESRD NA   M 1950 2000 2020}
\NormalTok{      2 2000 50.0 0.0    4.07     NRA      ESRD NA   M 1950 2000 2020}
\NormalTok{      3 2000 50.0 0.0   16.00     NRA      ESRD NA   M 1950 2000 2020}
\NormalTok{      4 2000 50.0 0.0    2.58     NRA      ESRD NA   M 1950 2000 2020}
\NormalTok{      5 2000 50.0 0.0    4.71     NRA      ESRD NA   M 1950 2000 2020}
\NormalTok{      6 2000 50.0 0.0    2.65     NRA      ESRD NA   M 1950 2000 2020}
\NormalTok{      7 2000 50.0 0.0    1.64     NRA      ESRD NA   M 1950 2000 2020}
\NormalTok{      8 2000 50.0 0.0    9.60     NRA      ESRD NA   M 1950 2000 2020}
\NormalTok{      9 2000 50.0 0.0    5.91     NRA      ESRD NA   M 1950 2000 2020}
\NormalTok{     10 2000 50.0 0.0   10.90     NRA      ESRD NA   M 1950 2000 2020}
\NormalTok{     11 2000 50.0 0.0    3.33     NRA      ESRD NA   F 1950 2000 2020}
\NormalTok{     12 2000 50.0 0.0    6.30     NRA      ESRD NA   F 1950 2000 2020}
\NormalTok{     13 2000 50.0 0.0   16.26     NRA      ESRD NA   F 1950 2000 2020}
\NormalTok{     14 2000 50.0 0.0    6.48     NRA      ESRD NA   F 1950 2000 2020}
\NormalTok{     15 2000 50.0 0.0    9.10     NRA       Rem NA   F 1950 2000 2020}
\NormalTok{     15 2009 59.1 9.1    4.37     Rem ESRD(Rem) NA   F 1950 2000 2020}
\NormalTok{     16 2000 50.0 0.0    6.40     NRA      ESRD NA   F 1950 2000 2020}
\NormalTok{     17 2000 50.0 0.0    5.29     NRA      ESRD NA   F 1950 2000 2020}
\NormalTok{     18 2000 50.0 0.0   12.02     NRA      ESRD NA   F 1950 2000 2020}
\NormalTok{     19 2000 50.0 0.0    6.74     NRA      ESRD NA   F 1950 2000 2020}
\NormalTok{     20 2000 50.0 0.0    6.14     NRA      ESRD NA   F 1950 2000 2020}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{     To}
\NormalTok{From  NRA Rem ESRD ESRD(Rem) Records: Events: Risk time: Persons:}
\NormalTok{  NRA   0   0   10         0       10      10       60.8       10}
...
\NormalTok{     To}
\NormalTok{From  NRA Rem ESRD ESRD(Rem) Records: Events: Risk time: Persons:}
\NormalTok{  NRA   0   1    9         0       10      10      78.05       10}
\NormalTok{  Rem   0   0    0         1        1       1       4.37        1}
\NormalTok{  Sum   0   1    9         1       11      11      82.42       10}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{     To}
\NormalTok{From  NRA Rem ESRD ESRD(Rem) Records: Events: Risk time: Persons:}
\NormalTok{  NRA  45  78  377         0      500     455       2803      500}
\NormalTok{  Rem   0  55    0        23       78      23        530       78}
\NormalTok{  Sum  45 133  377        23      578     478       3333      500}
...
\NormalTok{     To}
\NormalTok{From  NRA Rem ESRD ESRD(Rem) Records: Events: Risk time: Persons:}
\NormalTok{  NRA  26 148  326         0      500     474       2521      500}
\NormalTok{  Rem   0  88    0        60      148      60        958      148}
\NormalTok{  Sum  26 236  326        60      648     534       3479      500}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  50.1 494   3    3         0}
\NormalTok{  50.2 490   6    4         0}
\NormalTok{  50.3 486   9    5         0}
\NormalTok{  50.4 479  16    5         0}
\NormalTok{  50.5 477  16    7         0}
\NormalTok{  50.6 472  20    8         0}
\NormalTok{  50.7 468  22   10         0}
\NormalTok{  50.8 463  24   13         0}
\NormalTok{  50.9 458  26   16         0}
\NormalTok{  51   456  27   17         0}
\NormalTok{  51.1 453  28   19         0}
\NormalTok{  51.2 443  33   24         0}
\NormalTok{  51.3 439  32   28         1}
\NormalTok{  51.4 432  33   34         1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  50.1 0.006 0.994    1         1}
\NormalTok{  50.2 0.012 0.992    1         1}
\NormalTok{  50.3 0.018 0.990    1         1}
\NormalTok{  50.4 0.032 0.990    1         1}
\NormalTok{  50.5 0.032 0.986    1         1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{      State}
\NormalTok{when     Rem   NRA  ESRD ESRD(Rem)}
\NormalTok{  59.5 0.208 0.332 0.922         1}
\NormalTok{  59.6 0.208 0.326 0.922         1}
\NormalTok{  59.7 0.208 0.322 0.922         1}
\NormalTok{  59.8 0.206 0.320 0.920         1}
\NormalTok{  59.9 0.204 0.318 0.918         1}
\NormalTok{  60   0.202 0.314 0.916         1}
\end{Highlighting}
\end{Shaded}
